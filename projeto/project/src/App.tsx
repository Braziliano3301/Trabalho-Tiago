...
function App() {
  const [currentPage, setCurrentPage] = useState<'landing' | 'dashboard' | 'cadastro' | 'login'>('landing');
  ...
  if (currentPage === 'cadastro') {
    return (
      <div className="relative min-h-screen">
        <Cadastro onBack={() => setCurrentPage('landing')} />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Conteúdo com blur quando o login estiver aberto */}
      <div className={showLogin ? "filter blur-sm" : ""}>
        {/* Hero Section */}
